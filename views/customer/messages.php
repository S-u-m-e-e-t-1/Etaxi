...
<body>
    ...
    <script>
        ...
        function viewDetails(messageId) {
            // Find the message row using dataset directly
            ...
            .then(data => {
                if (data.success) {
                    ...
                    row.dataset.status = 'seen';
                    // Assuming status is in the 5th column
        ...
        function sendMessage(event) {
            ...
            const senderEmail = '<?php echo $customerData['email']; ?>';
